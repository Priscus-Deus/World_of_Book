...
class Author(models.Model):
    ...
    date_of_birth = models.DateField(help_text="Ввекдите дату рождения", verbose_name='Дата рождения', null=True, blank=True)
    date_of_death = models.DateField(help_text="Ввекдите дату смерти", verbose_name='Дата смерти', null=True, blank=True)
...
class Book(models.Model):
    ...
    genre = models.ForeignKey('Genre', on_delete=models.CASCADE, verbose_name="Жанр книги", null=True)
    ...
    author = models.ManyToManyField('Author', help_text="Введите название книги", verbose_name="Автор книги")
...
class BookInstance(models.Model):
    ...
    inv_nom = models.CharField(max_length=20, help_text="Введите инвентарный номер", verbose_name="Инвентарный номер")
    imprint = models.CharField(max_length=200, help_text='Введите издательство и год выпуска', verbose_name='Издательство')
    status = models.ForeignKey('Status', on_delete=models.CASCADE, help_text="Введите статус экземпляра книги", verbose_name="Статус экземпляра книги",null=True)
